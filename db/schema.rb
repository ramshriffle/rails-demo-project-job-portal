...
ActiveRecord::Schema[7.0].define(version: 2023_09_22_090330) do
  ...
  create_table "user_applications", force: :cascade do |t|
    ...
    t.index ["job_id"], name: "index_user_applications_on_job_id"
  ...
  add_foreign_key "user_applications", "jobs"
